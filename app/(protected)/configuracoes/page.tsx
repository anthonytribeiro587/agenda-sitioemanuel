...
export default function ConfiguracoesPage() {
  ...
  return <main className="page">
    ...
    <div className="grid-2">
      ...
      <section className="panel"><div className="panel-header"><div><h3 className="panel-title">Checklist de implantação</h3><p className="panel-subtitle">O que falta antes do uso oficial.</p></div></div><div className="panel-body"><div className="login-features config-checklist"><div className="login-feature"><CheckCircle2/>Criar projeto no Supabase</div><div className="login-feature"><CheckCircle2/>Executar migration do banco</div><div className="login-feature"><KeyRound/>Cadastrar variáveis na Vercel</div><div className="login-feature"><UserRoundCog/>Criar usuário da responsável</div></div></div></section>
    </div>
  </main>;
}
